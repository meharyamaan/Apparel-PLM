...
const Login = ({ setToken, setLoginUserData }) => {
  ...
  const handleSubmitSignIn = async (event) => {
    ...
    if (response.ok) {
      ...
      setToken(json.token);
      navigate("/");
      setLoginUserData(json.userdata);
    } else {
    ...
    <>
      {!signUp ? (
        <section className="relative flex justify-center  lg:items-center">
          <div className="w-full px-2 py-12 lg:w-1/2 sm:px-6 lg:px-8 sm:py-16 ">
            <div className="max-w-lg mx-auto">
              <form
                className="p-8 mb-0 space-y-4 rounded-lg shadow-2xl "
                onSubmit={handleSubmitSignIn}
              >
                <h1 className="text-center justify-center font-bold text-2xl mb-12">
                  Apparelpml
                </h1>
                ...
                <p className="px-6 text-sm text-center dark:text-gray-600">
                  ...
                  <button
                    className="hover:underline text-sm font-bold px-2 dark:text-indigo-800"
                    onClick={setState}
                  >
                    Sign up
                  </button>

  ...
  <div className="row">
    ...
    <div className="hero-inner">
      <div className="hero-copy">
        <h1 className="hero-title mt-0" style={{color:'white'}}>You Can Never Go Wrong With Our Quality</h1>
        <p className="hero-paragraph" style={{color:'#9D9D9D'}}>
          We Streamline Your Order
        </p>
